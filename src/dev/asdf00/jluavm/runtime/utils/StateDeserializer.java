...
public class StateDeserializer {
    public static Coroutine deserialize(LuaVM vm, Map<String, ApiFunctionRegistry> registries, byte[] rawState) {
            ...
            switch (lobj.type) {
                case 0b10_0000 -> {
                    ...
                    if (rdr.readByte() == 1) {
                        ...
                        lobj.refVal = registries.get(regName).getFunction(funcName, env, closures, additional);
                    } else {
                        ...
                        try {
                            lobj.refVal = vm.compile(code)[unitIdx].newInstance(env, closures);
