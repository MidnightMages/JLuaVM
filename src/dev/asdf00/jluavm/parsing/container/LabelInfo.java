...
public class LabelInfo {
    ...
    public final int definedClosablesInScope;
    ...
    public LabelInfo(Position pos, VarInfo[][] definedVars, int definedClosablesInScope, int scopeId, int jmpNo, boolean isInLoopScope) {
        this.pos = pos;
        this.definedVars = definedVars;
        this.definedClosablesInScope = definedClosablesInScope;
